...
; TODO: consider removing - blitter is faster on 68000.
; TODO: remove dead code

; Copies 8*8 pixels in 4 planes using CPU when inputs are ODD addresses.
; In:   = \1 Planar source (top).
; In:   = \2 Planar destination (top).
ODDCPY168 MACRO
	move.b	0*40(\1),0*40(\2)
	move.b	0*40+1(\1),0*40+1(\2)
	move.b	1*40(\1),1*40(\2)
	move.b	1*40+1(\1),1*40+1(\2)
	move.b	2*40(\1),2*40(\2)
	move.b	2*40+1(\1),2*40+1(\2)
	move.b	3*40(\1),3*40(\2)
	move.b	3*40+1(\1),3*40+1(\2)

	move.b	4*40(\1),4*40(\2)
	move.b	4*40+1(\1),4*40+1(\2)
	move.b	5*40(\1),5*40(\2)
	move.b	5*40+1(\1),5*40+1(\2)
	move.b	6*40(\1),6*40(\2)
	move.b	6*40+1(\1),6*40+1(\2)
	move.b	7*40(\1),7*40(\2)
	move.b	7*40+1(\1),7*40+1(\2)

	move.b	8*40(\1),8*40(\2)
	move.b	8*40+1(\1),8*40+1(\2)
	move.b	9*40(\1),9*40(\2)
	move.b	9*40+1(\1),9*40+1(\2)
	move.b	10*40(\1),10*40(\2)
	move.b	10*40+1(\1),10*40+1(\2)
	move.b	11*40(\1),11*40(\2)
	move.b	11*40+1(\1),11*40+1(\2)

	move.b	12*40(\1),12*40(\2)
	move.b	12*40+1(\1),12*40+1(\2)
	move.b	13*40(\1),13*40(\2)
	move.b	13*40+1(\1),13*40+1(\2)
	move.b	14*40(\1),14*40(\2)
	move.b	14*40+1(\1),14*40+1(\2)
	move.b	15*40(\1),15*40(\2)
	move.b	15*40+1(\1),15*40+1(\2)

	move.b	16*40(\1),16*40(\2)
	move.b	16*40+1(\1),16*40+1(\2)
	move.b	17*40(\1),17*40(\2)
	move.b	17*40+1(\1),17*40+1(\2)
	move.b	18*40(\1),18*40(\2)
	move.b	18*40+1(\1),18*40+1(\2)
	move.b	19*40(\1),19*40(\2)
	move.b	19*40+1(\1),19*40+1(\2)

	move.b	20*40(\1),20*40(\2)
	move.b	20*40+1(\1),20*40+1(\2)
	move.b	21*40(\1),21*40(\2)
	move.b	21*40+1(\1),21*40+1(\2)
	move.b	22*40(\1),22*40(\2)
	move.b	22*40+1(\1),22*40+1(\2)
	move.b	23*40(\1),23*40(\2)
	move.b	23*40+1(\1),23*40+1(\2)

	move.b	24*40(\1),24*40(\2)
	move.b	24*40+1(\1),24*40+1(\2)
	move.b	25*40(\1),25*40(\2)
	move.b	25*40+1(\1),25*40+1(\2)
	move.b	26*40(\1),26*40(\2)
	move.b	26*40+1(\1),26*40+1(\2)
	move.b	27*40(\1),27*40(\2)
	move.b	27*40+1(\1),27*40+1(\2)

	move.b	28*40(\1),28*40(\2)
	move.b	28*40+1(\1),28*40+1(\2)
	move.b	29*40(\1),29*40(\2)
	move.b	29*40+1(\1),29*40+1(\2)
	move.b	30*40(\1),30*40(\2)
	move.b	30*40+1(\1),30*40+1(\2)
	move.b	31*40(\1),31*40(\2)
	move.b	31*40+1(\1),31*40+1(\2)
